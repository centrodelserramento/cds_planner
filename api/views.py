...
try:
    from home.models import Order, Order
...
class OrderView(APIView):
    ...
    def get(self, request, pk=None):
        if not pk:
            return Response(
                {
                    "data": [
                        OrderSerializer(instance=obj).data
        ...
        return Response(
            {"data": OrderSerializer(instance=obj).data, "success": True},
            status=HTTPStatus.OK,
        )
    ...
    def put(self, request, pk):
        ...
        serializer = OrderSerializer(instance=obj, data=request.data, partial=True)
        if not serializer.is_valid():
            return Response(
                data={**serializer.errors, "success": False},
                status=HTTPStatus.BAD_REQUEST,
